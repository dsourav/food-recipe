...
class FoodRecipeItem extends StatelessWidget {
  ...
  const FoodRecipeItem({super.key, required this.foodRecipeEntity, required this.onTapSave, required this.onTap});
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                              ...
                              child: Icon(
                                ...
                                color: foodRecipeEntity.isSavedLocally ? Colors.green : null,
                              )),
                        ),
                      )
                    ],
